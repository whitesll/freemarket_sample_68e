...
$(document).on('turbolinks:load', function(){
  $(function(){
    ...
    function appendChidrenBox(insertHTML){
      ...
      $('.product__detail__box2__select').append(childSelectHtml);
    }
    ...
    function appendGrandchidrenBox(insertHTML){
      ...
      $('.product__detail__box2__select').append(grandchildSelectHtml);
    }

    // 親カテゴリー選択後のイベント
    $('#parent_category').on('change', function(){
      var parent_category_id = $('#parent_category').val(); //選択された親カテゴリーの名前を取得
    ...
    // 子カテゴリー選択後のイベント
    $('.product__detail__box2__select').on('change', '#child_category', function(){
